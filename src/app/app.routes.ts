...
import {VehiclesPage} from '@app/vehiclemanagement/presentation/pages/vehicles-page/vehicles-page';
import {VehicleDetailsPage} from '@app/vehiclemanagement/presentation/pages/vehicle-details-page/vehicle-details-page';
